...
document.getElementById("boxRates").innerHTML = `${boxRates}`
...
document.getElementById("yesButton").onclick = function() { openBox(boxName); setBoxColor(boxColor); removeYesFunction() }
document.getElementById("purchaseTheBox").innerHTML = `Purchase the ${boxName} Box`
document.getElementById("forTokens").innerHTML = `for ${boxPrice} tokens?`
}
...
var boxImage1 = dataSplit[3];
var boxImage2 = dataSplit[4];
var boxImage3 = dataSplit[5];
var boxImage4 = dataSplit[6];
var boxRates = dataSplit[7];
document.getElementById(`box${i}`).innerHTML = `<div class="styles__box___2pZ5d-camelCase" role="button" onclick="showBuy('${boxName}', '${boxPrice}', '${boxColor}', '${boxRates}')" tabindex="0"><div class="styles__boxHeader___UoHkq-camelCase">${boxName} Box</div><div class="styles__middleBoxContainer___e-Gwl-camelCase"><div class="styles__miniBlookContainer___1Y4oH-camelCase"><div class="styles__blookContainer___GKC0D-camelCase styles__miniBlook___3eAjl-camelCase"><img src="${boxImage1}" alt="" draggable="false" class="styles__blook___2Yq1S-camelCase" /></div><div class="styles__blookContainer___GKC0D-camelCase styles__miniBlook___3eAjl-camelCase"><img src="${boxImage2}" alt="" draggable="false" class="styles__blook___2Yq1S-camelCase" /></div><div class="styles__blookContainer___GKC0D-camelCase styles__miniBlook___3eAjl-camelCase"><img src="${boxImage3}" alt="" draggable="false" class="styles__blook___2Yq1S-camelCase" /></div><div class="styles__blookContainer___GKC0D-camelCase styles__miniBlook___3eAjl-camelCase"><img src="${boxImage4}" alt="" draggable="false" class="styles__blook___2Yq1S-camelCase" /></div></div><div class="styles__mysteryBoxIcon___18nWF-camelCase" style="background-color:${boxColor};">?</div> </div> <div class="styles__boxTokenContainer___1clGF-camelCase"> <div class="styles__boxTokenText___NdiWk-camelCase">${boxPrice}</div>
...
setTimeout(() => document.getElementById("mysteryBoxMenu").onclick = function() { closeMysteryMenu(); resetBoxOpen() }, 3250);
}
